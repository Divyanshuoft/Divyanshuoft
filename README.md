...
```
I'm currently working on creating a web app integrating React, MongoDB for video conferencing and efficient team collaboration.
```
>(CSCC01 course project, expected completion: August, 2023)
